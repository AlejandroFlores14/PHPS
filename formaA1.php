...
<body>
	...
	<section style="background-color: orange;">
		<form method="post" action="FormaA.php">
			<br><br>
			<label>Introduzca lado A.</label>
			<input type="text" name="ladA"/><br><br>
			<label>Introduzca lado B.</label>
			<input type="text" name="ladB"/><br><br>
			<label>Introduzca lado C.</label>
			<input type="text" name="ladC"/><br><br>
