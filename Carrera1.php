...
<head>
	<meta charset="utf-8">
	<title>Carreras de Universidad</title>
...
<body>
	...
	<section style="background-color: violet;">
		<form method="post" action="Carrera.php">
			<br><br>
			<label>Introduzca su matricula.</label>
			<input type="text" name="mat"/><br><br>
			<label>Introduzca su semestre.</label>
			<input type="text" name="sem"/><br><br>
			<label>Introduzca su promedio.</label>
